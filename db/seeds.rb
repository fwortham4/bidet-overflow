User.create(user_name: "sohel", email: "sohel.bootwala@gmail.com",hash_password: "password")

Question.create(title: "gummy worms", content: "i love them sooooo much", user_id: 1)

User.create(user_name: "billybob", email: "billy_bob@gmail.com", hash_password: "password")
